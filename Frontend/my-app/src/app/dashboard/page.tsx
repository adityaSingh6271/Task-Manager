...
export default function DashboardPage() {
  ...
  return <div className="dashboard-ui min-h-screen bg-muted/30">
    <Header user={data?.user} isLoading={isLoading} selectedFolder={selectedFolder} onFolderSelect={setSelectedFolder} />
    <div className="flex min-h-[calc(100vh-73px)]">
      <aside className="hidden w-72 shrink-0 border-r bg-background lg:block"><Sidebar selectedFolder={selectedFolder} onFolderSelect={setSelectedFolder} /></aside>
